...
<div class="wrap">
	...
	<div class="form-wrap">
		...
		<form name="gNews_form" method="post" action="#" onsubmit="return gNews_submit()"  >
		    <h3><?php _e('Update news details', 'news-announcement-scroll'); ?></h3>
			...
			<p class="submit">
			<input name="publish" lang="publish" class="button-primary" value="<?php _e('Update Details', 'news-announcement-scroll'); ?>" type="submit" />
